...
"DELETE"          :"Применяется к почтовым ящикам. Сервер IMAP удаляет почтовый ящик с именем, указанным в качестве аргумента команды.",
...
"NOOP"            :"Команда ничего не делает. Применяться для поддержки активности во время сеанса (!таймер ожидания)."
}